            ...
            <div class="col-lg-12">
                <div class="card-body">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        @if (in_array('create', json_decode(Auth::user()->role->permission->supplier_option)))
                            <a class="btn btn-primary me-md-2" type="button" href="{{ route('supplier-create') }}">Buat
                                Permintaan</a>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    @if (in_array('read', json_decode(Auth::user()->role->permission->supplier_option)))
