    ...
    <section class="section dashboard">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('harga-store') }}" class="mt-4" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" value="Selisi Harga" disabled>
                            ...
                            <div class="table-responsive mb-3">
                                <table class="table table-bordered" id="price-table">
                                    ...
                                    <tbody id="asset-list">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="price_pos[]"></td>
                                            <td><input type="text" class="form-control" name="price_salesmode[]"></td>
                                            <td>
                                ...
                                <button type="button" onclick="add()" class="btn btn-light btn-sm" id="add-table-price"><i
...
@section('script')
    <script>
        ...
        function add() {
            ...
            cell2.innerHTML = ` <input type="text" class="form-control" name="menu_name[]">`;

            const cell3 = document.createElement("td");
            cell3.innerHTML = `<input type="text" class="form-control" name="price_pos[]">`;

            const cell6 = document.createElement("td");
            cell6.innerHTML = `<input type="text" class="form-control" name="price_salesmode[]">`;
