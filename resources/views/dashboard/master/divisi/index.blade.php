            ...
            <div class="col-lg-12">
                <div class="card-body">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        @if (in_array('create', json_decode(Auth::user()->role->permission->divisi_option)))
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @if (in_array('read', json_decode(Auth::user()->role->permission->divisi_option)))
                                        @foreach ($divisions as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-sm-3">
                                                    @if (in_array('delete', json_decode(Auth::user()->role->permission->divisi_option)))
                                                        <form action="{{ route('divisi-delete', $id) }}" method="post">
                                                            @method('delete')
                                                            @csrf
